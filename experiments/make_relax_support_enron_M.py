#!/usr/bin/env python3
"""Support-measure relaxation figure for Enron -- M-weighted only
...
produced by relaxation_support.py."""
import os
import matplotlib
matplotlib.use("Agg")
...
axes[0].legend(handles=handles, fontsize=9.5, frameon=False,
...
#   <venv-python> make_relax_support_enron_M.py
# Render-only (no chains): needs relaxation_support_results/relax_enron_*.npy
# from relaxation_support.py. Output: relaxation_support_enron_M.{pdf,png}.
